...
```{r leaflet map panel,message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r plotly graph panel,message=FALSE, warning=FALSE, paged.print=FALSE}
require(plotly)
require(ggplot2)
plot_ly(avg.air.data.by.date, x = ~date.time, mode='lines') %>%  
  ...
  add_lines(y= 25, name="The WHO Guidelines for NO2 (24hrs mean)",line = list(shape = "spline", color="black",dash = 'dash')) %>%
  ...
  title = "Daily personal exposure variation in average hourly emissions of pollutants",
